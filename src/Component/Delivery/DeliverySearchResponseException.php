...
class DeliverySearchResponseException extends Exception implements
    AvailableJsonExceptionInterface,
    AvailableErrorsExceptionInterface,
    NoSentryExceptionInterface
{
    /**
     * @var array
     */
