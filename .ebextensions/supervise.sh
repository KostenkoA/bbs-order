...
[program:main_queue]
command=/var/app/current/bin/console --time-limit="now + 15 minutes" enqueue:consume --skip symfony_events
directory=/var/app/current
stdout_logfile=/var/app/current/var/log/main-queue.log
logfile_maxbytes=0
logfile_backups=0
